...
function Lboard() {
    ...
    react_1.useEffect(() => {
        axios_1.default.get(config.apiUrl + '/api/user/leaderboard').then(res => { setTableData(res.data); setLoaded(true); })
            .catch(err => { alert(err.message); setLoaded(true); });
    }, []);
    if (loaded) {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(PageTitle_1.default, { title: "Leaderboard" }),
            react_1.default.createElement(core_1.Grid, { container: true, spacing: 4 },
                react_1.default.createElement(core_1.Grid, { item: true, xs: 12 },
                    react_1.default.createElement(mui_datatables_1.default, { title: "Member List", data: tableData, columns: ["Name", "StatusStr"], options: { filterType: "checkbox", } })))));
    }
    else {
        return (react_1.default.createElement("div", null, " Loading... "));
    }
}
exports.default = Lboard;
;
